...
const elementClass = document.getElementsByClassName("parrafos");
...
const querySelector2 = document.querySelector(".parrafos");

const querySelectorAllClass = document.querySelectorAll(".parrafos");
...
const parrafaAClonar = document.createElement("p");

parrafaAClonar.textContent = "Soy un parrofo cloname";

const parafoClone = parrafaAClonar.cloneNode(true);
...
const Saludo = document.querySelector(".btnSaludar");
